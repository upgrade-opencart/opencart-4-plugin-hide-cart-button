...
class Product extends \Opencart\System\Engine\Controller {
	        	...
	        	public function showCart(): void {
					...
					if (isset($this->request->post['selected'])) {
						foreach ($this->request->post['selected'] as $product_id) {
							$this->model_catalog_product->showCartButton($product_id);
						}

						$json['success'] = 'Selected products updated successfully!';
					}
				...
				public function hideCart(): void {
					...
					if (isset($this->request->post['selected'])) {
						foreach ($this->request->post['selected'] as $product_id) {
							$this->model_catalog_product->hideCartButton($product_id);
						}
