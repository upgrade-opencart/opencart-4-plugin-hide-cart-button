...
class Product extends \Opencart\System\Engine\Model {
	        	...
	        	public function showCartButton(int $product_id): void {
					$this->db->query("UPDATE " . DB_PREFIX . "product SET add_cart = '1' WHERE product_id = '" . (int)$product_id . "'");
				}

				public function hideCartButton(int $product_id): void {
					$this->db->query("UPDATE " . DB_PREFIX . "product SET add_cart = '0' WHERE product_id = '" . (int)$product_id . "'");
				}
	...
	public function addProduct(array $data): int {
		...
		$product_id = $this->db->getLastId();
	        	...
	        	$this->db->query("UPDATE " . DB_PREFIX . "product SET add_cart = '" . (bool)(isset($data['add_cart']) ? $data['add_cart'] : 0) . "' WHERE product_id = '" . (int)$product_id . "'");
